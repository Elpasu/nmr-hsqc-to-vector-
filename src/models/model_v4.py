# -*- coding: utf-8 -*-
"""
Created on Thu Jan 22 17:09:39 2026
Modelo dos ramas para HSQC 
@author: UCA Team
"""
# -*- coding: utf-8 -*-
import torch
...
class NMR_Net(nn.Module):
    def __init__(self, num_classes=13):
        ...
        # --- RAMA 1: HSQC (2 Canales: Positivo y Abs(Negativo)) ---
        ...
        # --- FUSION DE CONDICION SIMPLE (Solo Total Señales) ---
        fusion_dim = self.flat_dim + 128 + 1
        
        self.fc_fusion1 = nn.Linear(fusion_dim, 128) 
        # Regularización segura (25%)
