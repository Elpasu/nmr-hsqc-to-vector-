...
# --- Entorno --------------------------------------------------------------
# OJO: en un job no-interactivo conda NO esta inicializado, hay que sourcear su
# profile.d/conda.sh antes de `conda activate`. La ubicacion del conda de
# Clementina NO esta verificada todavia -- ajustar CONDA_SH si esto falla
# (buscala con: `conda info --base` en el nodo de login).
